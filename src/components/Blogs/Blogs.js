...
const Blogs = () => {
    return (
        <div className='blogs'>
            ...
            <p>If we want to pass the value from parent component to immediate child component then we use prop drilling. But if we want to pass the value to the child of the child component then the value need to be pass from middle child then to that child. So prop drilling is not a good solution for this. Context API solve this problem. Context API is used to share the data with multiple component, without having to pass data through props manually.  </p>
